...
: CLanguageModel(iNumSyms), m_pRoot(pRoot), m_iMaxOrder(iMaxOrder<0 ? 5/*GetLongParameter(LP_LM_MAX_ORDER)*/ : iMaxOrder), bUpdateExclusion( 1/*GetLongParameter(LP_LM_UPDATE_EXCLUSION)*/!=0 ), m_ContextAlloc(1024) {
